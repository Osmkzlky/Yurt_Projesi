...
public class YoneticiEtkinlik extends JFrame {
	...
	public YoneticiEtkinlik(String isim,String gun,String saat,String adres,String firma, String iletisim,String not) throws ParseException {
		this.isim=isim;
		this.gun=gun;
		this.saat=saat;
		this.adres=adres;
		...
		btnNewButton.setBounds(0, 0, 60, 29);
        ...
        lblArkaPlan.setBounds(0, 0, 500, 670);
        ...
        btnKaydet.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				bufferedWriter.write(txtEtkinlikİsmi.getText()+"/"+txtEtkinlikGünü.getText()+"/"+txtEtkinlikSaati.getText()+"/"+txtEtkinlikAdresi.getText()+"/"+txtEtkinlikFirmasi.getText()+"/"+formattedTextField.getText()+"/"+txtEtkinlikNotu.getText());
				bufferedWriter.newLine();
				bufferedWriter.close();
				JOptionPane.showMessageDialog(null,txtEtkinlikİsmi.getText() +" adlı etkinlik düzenlendi","Etkinlik Planlama",JOptionPane.INFORMATION_MESSAGE);
				dispose();
				} catch (Exception e2) {
